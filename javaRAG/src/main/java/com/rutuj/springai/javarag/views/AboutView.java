package com.rutuj.springai.javarag.views;
...
public class AboutView extends VerticalLayout {
    ...
    public AboutView() {
        add(
                new H1("About JavaRAG"),
                new Html("""
                        <div>
                            <p>
                                JavaRAG is an example chat application that provides an AI chatbot that uses your own documents as context.
